...
<head>
    ...
    <script type="text/javascript">
        ...
        function initOnReady() {
            ...
            overrides = {
                "paneProperties.backgroundGradientStartColor": "#1f2631",
                "paneProperties.backgroundGradientEndColor": "#1f2631",
            };
            @else
                chartColor = {
                theme: 'light',
            ...
            window.tvWidget.onChartReady(function() {
                @if($theme == "dark")
                window.tvWidget.addCustomCSSFile('/chart-latest/charting_library/css/dark_custom_mobile.css')
                @else
                window.tvWidget.addCustomCSSFile('/chart-latest/charting_library/css/custom_mobile.css')
                @endif
            })
        };
